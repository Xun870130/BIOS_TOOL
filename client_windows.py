...
class AutoInstaller:
    """
    Controls the automatic mounting and operation of the Windows client.
    ...
    def start_installation(self):
        ...
        Controls the power, checks the status, opens a CMD window, starts the Windows client, and performs system restart
        to initiate GUI-based operations.

        This method will:
        - Power on the device.
        - Open the Windows client in CMD and restart the system.
        ...
        # Open CMD and start the Windows client
    ...
    def _perform_gui_actions(self):
        ...
        This method will:
        - Locate and click various UI elements such as dropdown, pin, and viewer.
        - Mount the ISO image and open CMD.
        """
        ...
        # Wait for the next screen to proceed
